...
/// <summary>
/// Verifies [Authorize(Roles = "Administrator")] on /api/admin/drivers. 401/403
...
/// Routes.RoutesAuthorizationTests — these run against a "Testing" host with
/// no PostgreSQL required. The "administrator succeeds" business-logic path is
/// covered separately by DriverServiceTests against mocked repositories.
/// </summary>
public class DriversAuthorizationTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly WebApplicationFactory<Program> _factory;

    public DriversAuthorizationTests(WebApplicationFactory<Program> factory)
    {
    ...
    [Theory]
    [InlineData("GET", "/api/admin/drivers")]
    [InlineData("GET", "/api/admin/drivers/00000000-0000-0000-0000-000000000000")]
    [InlineData("POST", "/api/admin/drivers")]
    [InlineData("PUT", "/api/admin/drivers/00000000-0000-0000-0000-000000000000")]
    [InlineData("PUT", "/api/admin/drivers/00000000-0000-0000-0000-000000000000/password")]
    ...
    [InlineData("PUT", "/api/admin/drivers/00000000-0000-0000-0000-000000000000")]
    [InlineData("PUT", "/api/admin/drivers/00000000-0000-0000-0000-000000000000/password")]
    public async Task DriverToken_CannotManageDrivers(string method, string path)
    {
