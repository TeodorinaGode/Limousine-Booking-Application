...
/// <summary>
/// Verifies [Authorize(Roles = "Administrator")] on /api/admin/vehicles. 401/403
...
/// covered separately by VehicleServiceTests against a mocked repository.
/// </summary>
public class VehiclesAuthorizationTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly WebApplicationFactory<Program> _factory;

    public VehiclesAuthorizationTests(WebApplicationFactory<Program> factory)
    {
    ...
    [Theory]
    [InlineData("GET", "/api/admin/vehicles")]
    [InlineData("GET", "/api/admin/vehicles/00000000-0000-0000-0000-000000000000")]
    [InlineData("POST", "/api/admin/vehicles")]
    [InlineData("PUT", "/api/admin/vehicles/00000000-0000-0000-0000-000000000000")]
    ...
    [InlineData("POST", "/api/admin/vehicles")]
    [InlineData("PUT", "/api/admin/vehicles/00000000-0000-0000-0000-000000000000")]
    public async Task DriverToken_CannotManageVehicles(string method, string path)
    {
